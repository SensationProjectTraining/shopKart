  ...
  return (
    <div>
      ...
      <div className=" bg-[url('https://img.freepik.com/premium-photo/curtain-with-brown-curtain-left-side_14117-9119.jpg')] p-3 flex flex-wrap justify-evenly">
        {isLoading
          ? Array.from({ length: 6 }).map((_, index) => (
              ...
              >
                ...
                <Skeleton className="mb-2" height={20} width="100%"></Skeleton>
        ...
        <Skeleton className='mb-3 mt-2' height={100} width="100%"></Skeleton>
        <Skeleton className='mb-2' height={30} width="100%"></Skeleton>
        ...
        <Skeleton height={30} width="20%"></Skeleton>
          ...
          storeData.map((product) => (
            <div
              key={product.id}
              className="bg-white border-4 border-yellow-400 h-[320px] w-[240px]  p-2  mt-7 rounded-xl shadow-amber-500 shadow-lg hover:scale-95 duration-300 ease-linear"
            >
